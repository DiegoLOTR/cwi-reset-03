...
public class FilmeService {
    ...
    public void criarFilme (FilmeRequest filmeRequest) throws CamposObrigatoriosException, IDNaoEncontradoException, GenerosIguaisException, AtorPersonagemRepetidosException {
        ...
        fakeDatabase.persisteFilme(new Filme(lastID,filmeRequest.getNome(),filmeRequest.getAnoLancamento(), filmeRequest.getCapaFilme(), filmeRequest.getGeneros(),diretor,estudio,listaPersonagensAtorGerados,filmeRequest.getResumo()));
