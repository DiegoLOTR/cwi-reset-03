   ...
   terceiroBug(); // Na classe QuantidadeMinimaItens os retornos de cafe e leite estavam invertidos, bem como cafe com acento na classe
    ...
    private static double registrarItem(String item, int quantidade) {
        ...
        if ("pao".equals(item) || "sanduiche".equals(item) || "torta".equals(item)) {
            ...
            } else if (quantidade <= DescontaEstoque.getEstoque(item)){
                DescontaEstoque.descontarItem(item, quantidade);
            } else {
                System.out.println("-------------------");
        ...
        System.out.println("-------------------");
        System.out.println("Solicitado a compra de " + quantidade + " " + item);
        System.out.println("Estoque restante de " + DescontaEstoque.getEstoque(item) + " " + item);
        System.out.println("-------------------");
